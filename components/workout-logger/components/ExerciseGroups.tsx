              ...
              <div key={exercise.id}>
                ...
                <div className="border-b border-border/30 relative bg-background hover:bg-muted/20 transition-colors">
                  <div className="py-3 px-1 sm:py-4 sm:px-2">
                    ...
                    {(exercise as any).progressionNote && !userOverrides[exercise.id] && (
                      <div className="bg-muted/50 border border-dashed border-border/40 rounded-md px-3 py-2 mb-3 text-xs text-muted-foreground">
