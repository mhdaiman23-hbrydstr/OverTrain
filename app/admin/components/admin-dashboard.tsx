              ...
              <Tabs defaultValue="overview" className="space-y-4">
                ...
                <TabsContent value="overview">
                  <div className="grid gap-6 lg:grid-cols-2">
                    ...
                    <Card>
                      <CardHeader>
                        <CardTitle>Workout Volume Trends (30 Days)</CardTitle>
                      </CardHeader>
                      <CardContent>
                        <ResponsiveContainer width="100%" height={300}>
                          <BarChart data={analytics.workoutTrends}>
                            <CartesianGrid strokeDasharray="3 3" />
                            <XAxis 
                              dataKey="date" 
                              tickFormatter={(value) => new Date(value).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}
                      ...
                      <CardContent>
                        <ResponsiveContainer width="100%" height={300}>
                          <PieChart>
                            <Pie
                              data={[
                                { name: 'Mobile', value: analytics.deviceUsage.mobile },
                                { name: 'Desktop', value: analytics.deviceUsage.desktop }
                              ]}
                              cx="50%"
                              cy="50%"
                              labelLine={false}
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <div className="h-64 flex items-center justify-center text-muted-foreground">
                          <p>Activity heatmap would show user engagement patterns throughout the week</p>
                        </div>
                      </CardContent>
                    </Card>
                  </div>
                      ...
                      <CardContent>
                        <div className="space-y-3">
                          <div className="flex items-center justify-between p-3 bg-muted/30 rounded">
                            <span className="font-medium">{analytics.mostUsedExercise}</span>
